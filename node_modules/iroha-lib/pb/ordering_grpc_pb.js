...
var proposal_pb = require('./proposal_pb.js');
...
function serialize_iroha_protocol_Proposal(arg) {
  if (!(arg instanceof proposal_pb.Proposal)) {
    throw new Error('Expected argument of type iroha.protocol.Proposal');
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_iroha_protocol_Proposal(buffer_arg) {
  return proposal_pb.Proposal.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var OrderingGateTransportGrpcService = exports.OrderingGateTransportGrpcService = {
  onProposal: {
    ...
    requestSerialize: serialize_iroha_protocol_Proposal,
    requestDeserialize: deserialize_iroha_protocol_Proposal,
